...
export default {
    data() {
        return {
            drawer: true,
            itemsCategory: [
                { title: "Home", icon1: "mdi-home-outline", icon2: "mdi-home", name: "new", to: "/home" },
                { title: "Shorts", icon1: "mdi-fire", icon2: "mdi-fire", name: "Shorts", to: "/home"  },
                { title: "Music", icon1: "mdi-music-note-outline", icon2: "mdi-music-note", name: "Music", to: "/home"  },
                { title: "Films", icon1: "mdi-movie-outline", icon2: "mdi-movie", name: "Films", to: "/home"  },
                { title: "Live", icon1: "mdi-account-tie-voice-outline", icon2: "mdi-account-tie-voice", name: "Live", to: "/home"  },
                { title: "Gaming", icon1: "mdi-gamepad-variant-outline", icon2: "mdi-gamepad-variant", name: "Gaming", to: "/home"  },
                { title: "Sports", icon1: "mdi-trophy-outline", icon2: "mdi-trophy", name: "Sports", to: "/home"  },
                { title: "Learning", icon1: "mdi-book-open-outline", icon2: "mdi-book-open", name: "Learning", to: "/home"  },
                { title: "Fashion & beauty", icon1: "mdi-tshirt-crew-outline", icon2: "mdi-tshirt-crew", name: "Fashion & beauty", to: "/home"  },
            ],
            itemsMenu: [
